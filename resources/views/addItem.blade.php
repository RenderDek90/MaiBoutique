...
<section class="grid justify-center bg-slate-100 ">
    ...
    <label for="clothes_name">Clothes Name</label>
        <input class="p-2 m-2 rounded border-form" type="text" name="clothes_name" placeholder="5-20 letters" required>

    <label for="clothes_name">Clothes Desc</label>
        <input type="text" class="p-2 m-2 rounded border-form" name="clothes_desc" id="" required placeholder="(min 5 letters)">

        <label for="clothes_price">Clothes Price</label>
        <input type="numeric" class="p-2 m-2 rounded border-form" name="price" id="" required placeholder=">1000">

        <label for="clothes_stock">Clothes Stock</label>
        <select name="stock" id="" class="mx-2 border-1">
            @for ($i = 1; $i < 100; $i++)
