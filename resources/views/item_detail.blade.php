        ...
        <div>
            <div class="bg-slate-100 px-10 py-5 block shadow-lg shadow-gray-400 rounded-lg max-w-2xl">
                <div class="flex flex-row gap-5">
                    <img src="{{URL('storage/images/'. $item->image)}}" class="max-h-[150px]" alt="">
                    <div class="">
                    ...
                    <form action="/item" method="POST" class="flex flex-col">
                        @csrf
                            ...
                            <div class="flex flex-row justify-between">
                                ...
                                <input class="bg-green-500 border-0 hover:bg-green-700 text-white border p-2 rounded w-[50%] h-[2.5em] hover:cursor-pointer" type="submit" value="Add to Cart">
                            </div>
                        <a href="/home" class="border-button border-red-500 p-2 rounded  w-[100px] hover:bg-red-500 text-red-500 hover:text-white mt-2">Back
                        </a>
                        </form>
