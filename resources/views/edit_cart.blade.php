...
{{-- Edit Card blm ada Controllernya atau Logicnya, bingung :) --}}
@section('container')
                    ...
                    <div class="">
                        ...
                        <form action="" class="">
                            ...
                            <div class="flex flex-row justify-center">
                                <input type="text" name="quantity_product" id="" required
                                    class="mr-3 h-[2.5em]">
                                <input
                                    class="bg-green-500 border-0 hover:bg-green-700 text-white border p-2 rounded w-[100%] h-[2.5em] hover:cursor-pointer"
                                    type="submit" value="Update Cart">
                            </div>
                            <a href="{{ url()->previous() }}"
                                class="border-button p-2 rounded border-red-500 w-[100px] hover:bg-red-500 text-red-500 hover:text-white mt-2">Back
